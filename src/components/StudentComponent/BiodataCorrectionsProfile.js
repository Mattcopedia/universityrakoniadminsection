...
import BiodataCorrections from './BiodataCorrections';

const BiodataCorrrectionsProfile = () => {
  ...
  return (
    ...
    { submit && (
      ...
      <FlexColumn>
        ...
        <Paragraph>
        Student Biodata <br className="responsivemodal"></br>has been updated
          successfully{" "}
        </Paragraph>
...
export default BiodataCorrrectionsProfile