  ...
  const [shouldshow, setShouldshow] = useState(false);
    ...
    return  ( 
      ...
      <FlexColumns>
       ...
       <FlexColumnRoot>
       <Paragraph> Create <br className="responsivemodal"></br>Sub-domain</Paragraph> 
     </FlexColumnRoot>
       </div>
       <div className="">   
       <ImageRoot src={`https://file.rendit.io/n/QsbJ6wKYH6A744UCJo2J.png`}   /> 
       </div>  
     ...
     <EditProfileRoot>Enter University details</EditProfileRoot>
        ...
        <div className="container ">
          <div className="flex flex-wrap ">       
            ...
            <FlexColumn>                       
                ...
                <select>
                    <option selected>Federal University of Technlogy, Akure, </option> 
                    <option>Federal University of Technlogy, Akure,  </option>
                    <option>Federal University of Technlogy, Akure,  </option>
                    <option>Federal University of Technlogy, Akure,  </option>
                    <option>Federal University of Technlogy, Akure,  </option> 
                </select>  
                ...
                <Text4 htmlFor="newdepartment"> University main domain</Text4>   
                <div className='pl-0.5'>     
                <input  style={{height: "44px"}} ref={focusDiv} className='form' id="subdomain"/>  
                </div>  
                ...
                <Text4 htmlFor="newdepartment"> Enter Sub-domain</Text4>   
                <div className='pl-0.5'>     
                <input  style={{height: "44px"}} ref={focusDiv} className='form' id="subdomain"/>  
                </div>  
                    ...
                    <button className='purplebtn' onClick={() => setShouldshow(true)} >Create Sub domain</button> 
                    </div>
