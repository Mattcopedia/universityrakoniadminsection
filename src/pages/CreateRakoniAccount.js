        ...
        <div class="max-w-7xl  grid grid-cols-12 ml-2 mb-3 md:ml-7 ">
             ...
             <FlexColumnaw>
                ...
                <div className='flex lg:gap-10 flex-col md:flex-col lg:flex-row'>
                 ...
                 <div className='flex-col'>
                  ...
                  <div className='flex lg:gap-10 flex-col md:flex-col lg:flex-row'>
                    ...
                    <div className="flex-col">
                 <Text4aw htmlFor="admin"> Admin user name</Text4aw>
                  <FlexColumn2aw margin={`0px 0px 10px 0px`}> 
                  <div className='pr-14 md:pr-0 lg:pr-0'>      
                 ...
                 <div className='flex flex-col'>
                  <Text4aw htmlFor="regnumber">Registration number</Text4aw>
                  <FlexColumn2aw margin={`0px 0px 10px 0px`}> 
                  <div className=' md:pr-0 lg:pr-0'>      
                  <input  style={{height:"40px", width:"140px"}} ref={focusDiv} className='form' type="text" id="regnumber"/>  
                  </div>
                  </FlexColumn2aw>  
                  </div>
                  ...
                  <div className='flex flex-col'>
                  <Text4aw htmlFor="date">Date</Text4aw>
                <WhiteFlexRow style={{height:"40px"}} onChange={handleChangeDate} value={date} type="date" id="date" name="date" />
                </div>
                ...
                <p  className='text-black pl-2 text-center lg:pl-1 cursor-pointer'>Cancel</p>   
                 ...
                 <RectangleRoot>
                <p  className='text-white  pl-2 text-center lg:pl-1 cursor-pointer'>Register</p>   
                </RectangleRoot>  
                </div>
...
export default CreateRakoniAccount